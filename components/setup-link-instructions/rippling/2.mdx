...
Copy the **Idp Metadata URL** or **Idp Metadata XML** from the next screen. You'll need this value to configure your SAML connection in Polis.
...
This is because Rippling sends dummy values for the **InResponseTo** field and Polis will try to validate the **InResponseTo** field if it is present.
