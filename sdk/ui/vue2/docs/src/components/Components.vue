<script setup>
import { Login } from '@boxyhq/vue2-ui';
</script>
    ...
    <div class="body-components">
      <div class="login-with-custom-styles">
        ...
        <h2 class="hero-description">
          Refer the code below to see the passed props. Also supported is the passing of style attribute for each inner
          element (Note that inline style will override other styles).
        </h2>
...
{{ loginWithCustomStyling }}   
      ...
      <div class="login-default-styles">
        ...
        <h2 class="hero-description">
          If classNames prop is not passed in, then default styling will be applied. Also supported is the passing of
          style attribute for each inner element (Note that inline style will override other styles).
        </h2>
...
{{ loginWithoutInput }}  
      ...
      <div class="login-with-failing-onsubmit">
        <Login
          @onSubmitted="onSubmitButton"
          :errorMessage="this.errorOnSubmit"
          class="child"
          inputLabel="Team domain *"
          placeholder="contoso@boxyhq.com"
        />
