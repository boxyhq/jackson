...
export const EmptyState = ({ title, description }: { title: string; description?: string | null }) => {
  return (
    <div className='my-2 flex w-full flex-col items-center justify-center rounded-sm lg:p-20 border gap-2 bg-white dark:bg-black h-80 border-slate-300 dark:border-white'>
