  ...
  return (
    <>
      <div className='mb-5 flex items-center justify-between'>
        ...
        <Link legacyBehavior={true} href={'/admin/directory-sync/new'}>
          <a className='btn-primary btn'>+ New Directory</a>
        </Link>
      </div>
                    ...
                    <tr
                      ...
                      <td className='px-6'>
                        <div className='flex flex-row'>
                          <Link legacyBehavior={true} href={`/admin/directory-sync/${directory.id}`}>
                            <a className='link-primary'>
                              <CircleStackIcon className='h-5 w-5 text-secondary' />
                            </a>
                          </Link>
                          <Link legacyBehavior={true} href={`/admin/directory-sync/${directory.id}/edit`}>
                            <a className='link-primary'>
