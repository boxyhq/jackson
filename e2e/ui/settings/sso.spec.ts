...
const MOCKLAB_ISSUER = 'https://oauth.mocklab.io';
const MOCKLAB_AUTHORIZATION_ENDPOINT = 'https://oauth.mocklab.io/oauth/authorize';
const MOCKLAB_TOKEN_ENDPOINT = 'https://oauth.mocklab.io/oauth/token';
const MOCKLAB_USERINFO_ENDPOINT = 'https://oauth.mocklab.io/userinfo';
const MOCKLAB_JWKS_URI = 'https://oauth.mocklab.io/.well-known/jwks.json';
