...
// Create a connection
export const createConnection = async (request: APIRequestContext) => {
...
// Get a connection
export const getConnection = async (request: APIRequestContext) => {
...
// Delete a connection
export const deleteConnection = async (request: APIRequestContext) => {
